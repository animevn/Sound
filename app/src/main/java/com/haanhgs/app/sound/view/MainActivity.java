...
public class MainActivity extends AppCompatActivity {
    ...
    private float initialVolume = 0.2f;
    ...
    private void setupSeekBar() {
        sbrVolume.setProgress((int) (initialVolume * 100));
    ...
    private void initViewModel() {
        ...
        viewModel.setVolume(initialVolume);
        viewModel.getLiveData().observe(this, sound ->
                tvVolume.setText(
                        String.format(Locale.getDefault(), "%.0f", sound.getVolume()*100))
        );
    }
